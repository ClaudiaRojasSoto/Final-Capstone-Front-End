      ...
      <div className="container">
        <div className="row justify-content-center align-items-center">
          <div className="col-10">
            <form onSubmit={handleSubmit} className="create-form p-2">
              <h3 className=" text-center text-white">Create Car</h3>
              <div>
                <div>
                  <label htmlFor="name" className="text-white input-text w-100">
                    Name:
                ...
                <div>
                  <label htmlFor="description" className="text-white input-text w-100">
                    Description:
                ...
                <div>
                  <label htmlFor="deposit" className="text-white input-text w-100">
                    Deposit:
                ...
                <div>
                  <label htmlFor="finance_fee" className="text-white input-text w-100">
                    Finance Fee:
                ...
                <div>
                  <label htmlFor="option_to_purchase_fee" className="text-white input-text w-100">
                ...
                <div>
                  <label htmlFor="total_amount_payable" className="text-white input-text w-100">
                ...
                <div>
                  <label htmlFor="duration" className="text-white input-text w-100">
                    Duration:
                ...
                <div>
                  <label htmlFor="removed" className="text-white input-text">
                    <div className="d-flex gap-1">
                      Removed:
                      <input className="input-field px-1" type="checkbox" id="removed" name="removed" checked={carData.removed} onChange={handleInputChange} />
                    </div>
                  </label>
                </div>

                <div>
                  <label htmlFor="image" className="text-white input-text w-100">
                    Image:
